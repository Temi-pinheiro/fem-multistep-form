  ...
  return (
    <div className='flex flex-col items-center justify-center h-full gap-y-8'>
      ...
      <motion.div
        ...
        className='flex flex-col items-center gap-y-[14px]'
      >
        <h2 className='font-bold text-[32px] text-[#022959] '>Thank You!</h2>
        <p className='text-center text-[#9699AA] max-w-[450px] leading-[25px]'>
